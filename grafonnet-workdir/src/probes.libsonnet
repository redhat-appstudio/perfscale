...

{
  ...
  completeDashboard(
    ...
    local templatingDirFilter = if templatingDir == 'SingleArchLike' then "(label_values->>'__parameters_options_PipelineRepoTemplatingSourceDir' IS NULL OR label_values->>'__parameters_options_PipelineRepoTemplatingSourceDir' = '' OR label_values->>'__parameters_options_PipelineRepoTemplatingSourceDir' = 'nodejs-devfile-sample-test/' OR label_values->>'__parameters_options_PipelineRepoTemplatingSourceDir' = 'nodejs-devfile-sample-SingleArch/')" else if templatingDir == 'MultiArchLike' then "(label_values->>'__parameters_options_PipelineRepoTemplatingSourceDir' = 'nodejs-devfile-sample-MultiArch/' OR label_values->>'__parameters_options_PipelineRepoTemplatingSourceDir' = 'nodejs-devfile-sample-MultiArch-only-ARM-and-AMD/')" else '';
