...
// Finally dashboard
dashboard.new('Performance: Controllers resources and restarts overview (namespaces starting with o - z)')
...
+ dashboard.withPanels(
  grafonnet.util.grid.makeGrid([
    ...
    myRow('openshift-pipelines', 'tekton-pipelines-webhook-[0-9a-z-]+'),
    ...
    myRow('product-kubearchive', 'kubearchive-operator-[0-9a-z-]+'),
